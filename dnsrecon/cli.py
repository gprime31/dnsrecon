...
def brute_srv(res, domain, verbose=False, thread_num=None):
    ...
    srvrcd = [
        ...
        '_jabber._udp.',
        '_kerberos._tcp.',
        '_kerberos._tcp.Y._sites.',
        '_kerberos._tcp.Y._sites.dc._msdcs.',
        '_kerberos._tcp.Yi._sites.',
        '_kerberos._tcp.Yi._sites.dc._msdcs.',
        '_kerberos._tcp.dc._msdcs.',
        '_kerberos._udp.',
        '_kerberos.tcp.dc._msdcs.',
        '_kpasswd._tcp.',
        ...
        '_ldap._tcp.',
        '_ldap._tcp.ForestDNSZones.',
        '_ldap._tcp.G. domains._msdcs.',
        '_ldap._tcp.Y._sites.',
        '_ldap._tcp.Y._sites.dc._msdcs.',
        '_ldap._tcp.Y._sites.gc._msdcs.',
        '_ldap._tcp.Yi._sites.',
        '_ldap._tcp.Yi._sites.dc._msdcs.',
        '_ldap._tcp.dc._msdcs.',
        '_ldap._tcp.gc._msdcs.',
        '_ldap._tcp.pdc._msdcs.',
        '_nntp._tcp.',
